...
#define UART0_UARTRSR_OE_MASK                              8

#define UART0_UARTRSR_BE_OFFSET                            2
#define UART0_UARTRSR_BE_MASK                              4

#define UART0_UARTRSR_PE_OFFSET                            1
#define UART0_UARTRSR_PE_MASK                              2

#define UART0_UARTRSR_FE_OFFSET                            0
#define UART0_UARTRSR_FE_MASK                              1
...
#define UART0_UARTFR_BUSY_MASK                             8

#define UART0_UARTFR_DCD_OFFSET                            2
#define UART0_UARTFR_DCD_MASK                              4

#define UART0_UARTFR_DSR_OFFSET                            1
#define UART0_UARTFR_DSR_MASK                              2

#define UART0_UARTFR_CTS_OFFSET                            0
#define UART0_UARTFR_CTS_MASK                              1
...
#define UART0_UARTLCR_H_STP2_MASK                          8

#define UART0_UARTLCR_H_EPS_OFFSET                         2
#define UART0_UARTLCR_H_EPS_MASK                           4

#define UART0_UARTLCR_H_PEN_OFFSET                         1
#define UART0_UARTLCR_H_PEN_MASK                           2

#define UART0_UARTLCR_H_BRK_OFFSET                         0
#define UART0_UARTLCR_H_BRK_MASK                           1
...
#define UART0_UARTIMSC_DSRMIM_MASK                         8

#define UART0_UARTIMSC_DCDMIM_OFFSET                       2
#define UART0_UARTIMSC_DCDMIM_MASK                         4

#define UART0_UARTIMSC_CTSMIM_OFFSET                       1
#define UART0_UARTIMSC_CTSMIM_MASK                         2

#define UART0_UARTIMSC_RIMIM_OFFSET                        0
#define UART0_UARTIMSC_RIMIM_MASK                          1
...
#define UART0_UARTRIS_DSRRMIS_MASK                         8

#define UART0_UARTRIS_DCDRMIS_OFFSET                       2
#define UART0_UARTRIS_DCDRMIS_MASK                         4

#define UART0_UARTRIS_CTSRMIS_OFFSET                       1
#define UART0_UARTRIS_CTSRMIS_MASK                         2

#define UART0_UARTRIS_RIRMIS_OFFSET                        0
#define UART0_UARTRIS_RIRMIS_MASK                          1
...
#define UART0_UARTMIS_DSRMMIS_MASK                         8

#define UART0_UARTMIS_DCDMMIS_OFFSET                       2
#define UART0_UARTMIS_DCDMMIS_MASK                         4

#define UART0_UARTMIS_CTSMMIS_OFFSET                       1
#define UART0_UARTMIS_CTSMMIS_MASK                         2

#define UART0_UARTMIS_RIMMIS_OFFSET                        0
#define UART0_UARTMIS_RIMMIS_MASK                          1
...
#define UART0_UARTICR_DSRMIC_MASK                          8

#define UART0_UARTICR_DCDMIC_OFFSET                        2
#define UART0_UARTICR_DCDMIC_MASK                          4

#define UART0_UARTICR_CTSMIC_OFFSET                        1
#define UART0_UARTICR_CTSMIC_MASK                          2

#define UART0_UARTICR_RIMIC_OFFSET                         0
#define UART0_UARTICR_RIMIC_MASK                           1

#define UART0_UARTDMACR_DMAONERR_OFFSET                    2
#define UART0_UARTDMACR_DMAONERR_MASK                      4

#define UART0_UARTDMACR_TXDMAE_OFFSET                      1
#define UART0_UARTDMACR_TXDMAE_MASK                        2

#define UART0_UARTDMACR_RXDMAE_OFFSET                      0
#define UART0_UARTDMACR_RXDMAE_MASK                        1
