...
#define PLL_SYS_CS_LOCK_OFFSET                             31u
#define PLL_SYS_CS_LOCK_MASK                               0x80000000u

#define PLL_SYS_CS_BYPASS_OFFSET                           8u
#define PLL_SYS_CS_BYPASS_MASK                             0x100u

#define PLL_SYS_CS_REFDIV_OFFSET                           0u
#define PLL_SYS_CS_REFDIV_MASK                             0x3fu

#define PLL_SYS_PWR_VCOPD_OFFSET                           5u
#define PLL_SYS_PWR_VCOPD_MASK                             0x20u

#define PLL_SYS_PWR_POSTDIVPD_OFFSET                       3u
#define PLL_SYS_PWR_POSTDIVPD_MASK                         8u

#define PLL_SYS_PWR_DSMPD_OFFSET                           2u
#define PLL_SYS_PWR_DSMPD_MASK                             4u

#define PLL_SYS_PWR_PD_OFFSET                              0u
#define PLL_SYS_PWR_PD_MASK                                1u

#define PLL_SYS_FBDIV_INT_FBDIV_INT_OFFSET                 0u
#define PLL_SYS_FBDIV_INT_FBDIV_INT_MASK                   0xfffu

#define PLL_SYS_PRIM_POSTDIV1_OFFSET                       16u
#define PLL_SYS_PRIM_POSTDIV1_MASK                         0x70000u

#define PLL_SYS_PRIM_POSTDIV2_OFFSET                       12u
#define PLL_SYS_PRIM_POSTDIV2_MASK                         0x7000u
...
#define PLL_SYS ((PLL_SYS_type *) 0x40028000)
