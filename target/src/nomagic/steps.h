...
typedef struct{       //
    ...
    Result result;    //     RESULT_OK   | RESULT_OK          | RESULT_OK       | RESULT_OK             | RESULT_OK
    int32_t intern_0; //                 | transfer id        |
    uint32_t read_0;  //                 | value read from AP |                 | value read from APreg |
    step_typ type;    //    STEP_CONNECT | STEP_AP_READ       | STEP_AP_WRITE   | STEP_AP_REG_READ      | STEP_AP_REG_WRITE
